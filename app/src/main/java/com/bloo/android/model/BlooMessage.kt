...
@Parcelize
enum class BlooMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * BlooMessage - 100% compatible with iOS version
 */
@Parcelize
data class BlooMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: BlooMessageType = BlooMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): BlooMessage? {
            try {
