...
import com.bloo.android.nostr.GeohashMessageHandler
import com.bloo.android.nostr.GeohashRepository
import com.bloo.android.nostr.NostrDirectMessageHandler
import com.bloo.android.nostr.NostrIdentityBridge
import com.bloo.android.nostr.NostrProtocol
import com.bloo.android.nostr.NostrRelayManager
import com.bloo.android.nostr.NostrSubscriptionManager
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.bloo.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.bloo.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.bloo.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.bloo.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.bloo.android.model.BlooMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.bloo.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.bloo.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.bloo.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
            repo.setConversationGeohash(convKey, gh)
            com.bloo.android.nostr.GeohashConversationRegistry.set(convKey, gh)
        }
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.bloo.android.model.BlooMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.bloo.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.bloo.android.geohash.ChannelID.Mesh -> {
            ...
            is com.bloo.android.geohash.ChannelID.Location -> {
                ...
                viewModelScope.launch {
                    ...
                    com.bloo.android.nostr.GeohashAliasRegistry.put("nostr_${dmIdentity.publicKeyHex.take(16)}", dmIdentity.publicKeyHex)
                }
            }
            null -> {
