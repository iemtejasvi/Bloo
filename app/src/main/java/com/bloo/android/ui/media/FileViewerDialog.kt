...
import com.bloo.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: BlooFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("bloo_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
