...
import com.bloo.android.geohash.ChannelID
import kotlinx.coroutines.launch
import com.bloo.android.geohash.GeohashChannel
import com.bloo.android.geohash.GeohashChannelLevel
import com.bloo.android.geohash.LocationChannelManager
import com.bloo.android.geohash.GeohashBookmarksStore
import com.bloo.android.ui.theme.BASE_FONT_SIZE
...
private fun meshTitleWithCount(viewModel: ChatViewModel): String {
    ...
    val peopleText = ctx.resources.getQuantityString(com.bloo.android.R.plurals.people_count, meshCount, meshCount)
    val meshLabel = stringResource(com.bloo.android.R.string.mesh_label)
...
private fun geohashTitleWithCount(channel: GeohashChannel, participantCount: Int): String {
    val ctx = androidx.compose.ui.platform.LocalContext.current
    val peopleText = ctx.resources.getQuantityString(com.bloo.android.R.plurals.people_count, participantCount, participantCount)
    val levelName = when (channel.level) {
        com.bloo.android.geohash.GeohashChannelLevel.BUILDING -> "Building" // iOS: precision 8 for location notes
        com.bloo.android.geohash.GeohashChannelLevel.BLOCK -> stringResource(com.bloo.android.R.string.location_level_block)
        com.bloo.android.geohash.GeohashChannelLevel.NEIGHBORHOOD -> stringResource(com.bloo.android.R.string.location_level_neighborhood)
        com.bloo.android.geohash.GeohashChannelLevel.CITY -> stringResource(com.bloo.android.R.string.location_level_city)
        com.bloo.android.geohash.GeohashChannelLevel.PROVINCE -> stringResource(com.bloo.android.R.string.location_level_province)
        com.bloo.android.geohash.GeohashChannelLevel.REGION -> stringResource(com.bloo.android.R.string.location_level_region)
    }
