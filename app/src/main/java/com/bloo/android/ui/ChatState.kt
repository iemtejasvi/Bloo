...
class ChatState {
    ...
    private val _messages = MutableLiveData<List<BlooMessage>>(emptyList())
    val messages: LiveData<List<BlooMessage>> = _messages
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<BlooMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<BlooMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<BlooMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<BlooMessage>>> = _channelMessages
    ...
    private val _selectedLocationChannel = MutableLiveData<com.bloo.android.geohash.ChannelID?>(com.bloo.android.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.bloo.android.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setMessages(messages: List<BlooMessage>) {
    ...
    fun setPrivateChats(chats: Map<String, List<BlooMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<BlooMessage>>) {
    ...
    fun setSelectedLocationChannel(channel: com.bloo.android.geohash.ChannelID?) {
