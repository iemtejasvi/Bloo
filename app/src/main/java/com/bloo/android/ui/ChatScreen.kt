...
import com.bloo.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<BlooMessage?>(null) }
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.bloo.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.bloo.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.bloo.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.bloo.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.bloo.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.bloo.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: BlooMessage?,
    viewModel: ChatViewModel
) {
    // Password dialog
    ...
    if (showDebugSheet) {
        com.bloo.android.ui.debug.DebugSettingsSheet(
