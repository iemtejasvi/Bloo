...
import com.bloo.android.mesh.BluetoothMeshDelegate
import com.bloo.android.mesh.BluetoothMeshService
...
import com.bloo.android.util.NotificationIntervalManager
...
/**
 * Refactored ChatViewModel - Main coordinator for bloo functionality
...
class ChatViewModel(
    ...
    private val debugManager by lazy { try { com.bloo.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val messages: LiveData<List<BlooMessage>> = state.messages
    ...
    val privateChats: LiveData<Map<String, List<BlooMessage>>> = state.privateChats
    ...
    val channelMessages: LiveData<Map<String, List<BlooMessage>>> = state.channelMessages
    ...
    val selectedLocationChannel: LiveData<com.bloo.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            com.bloo.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.bloo.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.bloo.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.bloo.android.geohash.ChannelID.Mesh) {
        ...
        com.bloo.android.favorites.FavoritesPersistenceService.initialize(getApplication())


        // Ensure NostrTransport knows our mesh peer ID for embedded packets
        try {
            val nostrTransport = com.bloo.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.bloo.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.bloo.android.nostr.NostrSubscriptionManager
                val identity = com.bloo.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.bloo.android.nostr.NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = com.bloo.android.services.SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.bloo.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.bloo.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.bloo.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.bloo.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.bloo.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.bloo.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.bloo.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.bloo.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.bloo.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.bloo.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.bloo.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.bloo.android.services.MessageRouter
    ...
    override fun didReceiveMessage(message: BlooMessage) {
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = com.bloo.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    private fun clearAllCryptographicData() {
        try {
            ...
            try {
                com.bloo.android.favorites.FavoritesPersistenceService.shared.clearAllFavorites()
    ...
    fun selectLocationChannel(channel: com.bloo.android.geohash.ChannelID) {
