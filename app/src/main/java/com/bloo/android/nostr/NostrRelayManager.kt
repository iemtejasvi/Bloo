...
class NostrRelayManager private constructor() {
    ...
    companion object {
        ...
        private const val INITIAL_BACKOFF_INTERVAL = com.bloo.android.util.AppConstants.Nostr.INITIAL_BACKOFF_INTERVAL_MS  // 1 second
        private const val MAX_BACKOFF_INTERVAL = com.bloo.android.util.AppConstants.Nostr.MAX_BACKOFF_INTERVAL_MS    // 5 minutes
        private const val BACKOFF_MULTIPLIER = com.bloo.android.util.AppConstants.Nostr.BACKOFF_MULTIPLIER
        private const val MAX_RECONNECT_ATTEMPTS = com.bloo.android.util.AppConstants.Nostr.MAX_RECONNECT_ATTEMPTS
    ...
    private val SUBSCRIPTION_VALIDATION_INTERVAL = com.bloo.android.util.AppConstants.Nostr.SUBSCRIPTION_VALIDATION_INTERVAL_MS // 30 seconds
    
    // OkHttp client for WebSocket connections (via provider to honor Tor)
    private val httpClient: OkHttpClient
        get() = com.bloo.android.net.OkHttpProvider.webSocketClient()
