...
class BluetoothConnectionTracker(
    ...
    companion object {
        ...
        private const val CONNECTION_RETRY_DELAY = com.bloo.android.util.AppConstants.Mesh.CONNECTION_RETRY_DELAY_MS
        private const val MAX_CONNECTION_ATTEMPTS = com.bloo.android.util.AppConstants.Mesh.MAX_CONNECTION_ATTEMPTS
        private const val CLEANUP_DELAY = com.bloo.android.util.AppConstants.Mesh.CONNECTION_CLEANUP_DELAY_MS
        private const val CLEANUP_INTERVAL = com.bloo.android.util.AppConstants.Mesh.CONNECTION_CLEANUP_INTERVAL_MS // 30 seconds
    }
