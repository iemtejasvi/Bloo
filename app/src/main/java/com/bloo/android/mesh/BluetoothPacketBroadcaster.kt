...
class BluetoothPacketBroadcaster(
    ...
    companion object {
        ...
        private const val CLEANUP_DELAY = com.bloo.android.util.AppConstants.Mesh.BROADCAST_CLEANUP_DELAY_MS
    }
    ...
    private fun logPacketRelay(
        ...
        try {
            ...
            com.bloo.android.ui.debug.DebugSettingsManager.getInstance().logPacketRelayDetailed(
                packetType = typeName,
