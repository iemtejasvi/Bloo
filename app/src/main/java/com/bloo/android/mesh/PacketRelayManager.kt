 ...
 * 
 * This class handles all relay decisions and logic for bloo packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.bloo.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: BlooPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: BlooPacket, fromPeerID: String): Boolean {
