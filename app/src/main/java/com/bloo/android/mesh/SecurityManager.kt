...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
    ...
    companion object {
        ...
        private const val MESSAGE_TIMEOUT = com.bloo.android.util.AppConstants.Security.MESSAGE_TIMEOUT_MS // 5 minutes (same as iOS)
        private const val CLEANUP_INTERVAL = com.bloo.android.util.AppConstants.Security.CLEANUP_INTERVAL_MS // 5 minutes
        private const val MAX_PROCESSED_MESSAGES = com.bloo.android.util.AppConstants.Security.MAX_PROCESSED_MESSAGES
        private const val MAX_PROCESSED_KEY_EXCHANGES = com.bloo.android.util.AppConstants.Security.MAX_PROCESSED_KEY_EXCHANGES
    }
     ...
     */
    fun validatePacket(packet: BlooPacket, peerID: String): Boolean {
...
//        }
     ...
     */
    private fun generateMessageID(packet: BlooPacket, peerID: String): String {
     ...
     */
    private fun verifyPacketSignatureWithLogging(packet: BlooPacket, peerID: String) {
        try {
