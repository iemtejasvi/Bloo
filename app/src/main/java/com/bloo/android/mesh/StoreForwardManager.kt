...
class StoreForwardManager {
    ...
    companion object {
        ...
        private const val MESSAGE_CACHE_TIMEOUT = com.bloo.android.util.AppConstants.StoreForward.MESSAGE_CACHE_TIMEOUT_MS  // 12 hours for regular peers
        private const val MAX_CACHED_MESSAGES = com.bloo.android.util.AppConstants.StoreForward.MAX_CACHED_MESSAGES  // For regular peers
        private const val MAX_CACHED_MESSAGES_FAVORITES = com.bloo.android.util.AppConstants.StoreForward.MAX_CACHED_MESSAGES_FAVORITES  // For favorites
        private const val CLEANUP_INTERVAL = com.bloo.android.util.AppConstants.StoreForward.CLEANUP_INTERVAL_MS // 10 minutes
    }
     ...
     */
    fun cacheMessage(packet: BlooPacket, messageID: String) {
