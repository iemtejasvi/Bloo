...
import com.bloo.android.util.AppConstants
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.*
import kotlinx.coroutines.Job
import com.bloo.android.ui.debug.DebugSettingsManager
import com.bloo.android.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.bloo.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value) {
    ...
    fun onScanStateChanged(shouldScan: Boolean) {
        val enabled = try { com.bloo.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value } catch (_: Exception) { true }
    ...
    private fun connectToDevice(device: BluetoothDevice, rssi: Int) {
        ...
        val deviceAddress = device.address
        Log.i(TAG, "Connecting to bloo device: $deviceAddress")
        ...
        val gattCallback = object : BluetoothGattCallback() {
            ...
            override fun onCharacteristicChanged(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic) {
                ...
                val packet = BlooPacket.fromBinaryData(value)
                if (packet != null) {
