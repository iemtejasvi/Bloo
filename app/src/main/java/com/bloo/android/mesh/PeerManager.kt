...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = com.bloo.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        managerScope.launch {
            while (isActive) {
                delay(com.bloo.android.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
