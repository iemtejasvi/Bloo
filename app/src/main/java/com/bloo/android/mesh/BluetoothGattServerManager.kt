...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.bloo.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { com.bloo.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
