package com.bloo.android.mesh

import android.content.Context
import android.util.Log
import com.bloo.android.crypto.EncryptionService
import com.bloo.android.model.BlooMessage
import com.bloo.android.protocol.MessagePadding
import com.bloo.android.model.RoutedPacket
import com.bloo.android.model.IdentityAnnouncement
import com.bloo.android.protocol.BlooPacket
import com.bloo.android.protocol.MessageType
import com.bloo.android.protocol.SpecialRecipients
import com.bloo.android.model.RequestSyncPacket
import com.bloo.android.sync.GossipSyncManager
import com.bloo.android.util.toHexString
...
class BluetoothMeshService(private val context: Context) {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.bloo.android.util.AppConstants.MESSAGE_TTL_HOPS
    }
    ...
    init {
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.bloo.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.bloo.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.bloo.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
        ...
        gossipSyncManager.delegate = object : GossipSyncManager.Delegate {
            override fun sendPacket(packet: BlooPacket) {
                connectionManager.broadcastPacket(RoutedPacket(packet))
            }
            override fun sendPacketToPeer(peerID: String, packet: BlooPacket) {
                connectionManager.sendPacketToPeer(peerID, packet)
            }
            override fun signPacketForBroadcast(packet: BlooPacket): BlooPacket {
    ...
    private fun setupDelegates() {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun verifySignature(packet: BlooPacket, peerID: String): Boolean {
            ...
            override fun updatePeerIDBinding(newPeerID: String, nickname: String,
                ...
                try {
                    com.bloo.android.favorites.FavoritesPersistenceService.shared.findNostrPubkey(publicKey)?.let { npub ->
                        com.bloo.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(newPeerID, npub)
                    }
                } catch (_: Exception) { }
            ...
            // Callbacks
            override fun onMessageReceived(message: BlooMessage) {
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: BlooPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: BlooPacket): BlooPacket? {
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            override fun onPacketReceived(packet: BlooPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.bloo.android.ui.debug.DebugSettingsManager.getInstance()
     ...
     */
    fun sendFileBroadcast(file: com.bloo.android.model.BlooFilePacket) {
        try {
     ...
     */
    fun sendFilePrivate(recipientPeerID: String, file: com.bloo.android.model.BlooFilePacket) {
        try {
            ...
            serviceScope.launch {
                ...
                if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                    try {
                        ...
                        val noisePayload = com.bloo.android.model.NoisePayload(
                            type = com.bloo.android.model.NoisePayloadType.FILE_TRANSFER,
                            data = filePayload
                        )
                        ...
                        val packet = BlooPacket(
                            ...
                            payload = encrypted,
                            signature = null,
                            ttl = com.bloo.android.util.AppConstants.MESSAGE_TTL_HOPS
                        )
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.bloo.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.bloo.android.model.NoisePayload(
                        type = com.bloo.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.bloo.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.bloo.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.bloo.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }
            
            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.bloo.android.model.NoisePayload(
                    type = com.bloo.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = BlooPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.bloo.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
     ...
     */
    fun getSessionState(peerID: String): com.bloo.android.noise.NoiseSession.NoiseSessionState {
     ...
     */
    private fun signPacketBeforeBroadcast(packet: BlooPacket): BlooPacket {
        return try {
...
interface BluetoothMeshDelegate {
    fun didReceiveMessage(message: BlooMessage)
