...
import com.bloo.android.noise.southernstorm.protocol.*
 ...
 * 100% compatible with iOS bloo Noise Protocol
 */
class NoiseSession(
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.bloo.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour
        private const val REKEY_MESSAGE_LIMIT = com.bloo.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_SESSION // 10k messages
        ...
        private const val MAX_PAYLOAD_SIZE = com.bloo.android.util.AppConstants.Noise.MAX_PAYLOAD_SIZE_BYTES
        ...
        private const val HIGH_NONCE_WARNING_THRESHOLD = com.bloo.android.util.AppConstants.Noise.HIGH_NONCE_WARNING_THRESHOLD
