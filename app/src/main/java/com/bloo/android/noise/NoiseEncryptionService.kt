package com.bloo.android.noise

import android.content.Context
import android.util.Log
import com.bloo.android.identity.SecureIdentityStateManager
import com.bloo.android.mesh.PeerFingerprintManager
import com.bloo.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.bloo.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.bloo.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.bloo.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a BlooPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.bloo.android.protocol.BlooPacket): com.bloo.android.protocol.BlooPacket? {
    ...
    /**
     * Verify a BlooPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.bloo.android.protocol.BlooPacket, publicKey: ByteArray): Boolean {
