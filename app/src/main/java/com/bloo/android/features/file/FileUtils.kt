package com.bloo.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.bloo.android.model.BlooFilePacket
    ): String {
    ...
    /**
     * Classify BlooMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.bloo.android.model.BlooMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.bloo.android.model.BlooMessageType.Image
            lower.startsWith("audio/") -> com.bloo.android.model.BlooMessageType.Audio
            else -> com.bloo.android.model.BlooMessageType.File
        }
    }
}
