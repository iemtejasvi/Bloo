package com.bloo.android.crypto

import android.content.Context
import android.util.Log
import com.bloo.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in bloo.
...
class EncryptionService(private val context: Context) {
    ...
    fun clearPersistentIdentity() {
        ...
        try {
            val prefs = context.getSharedPreferences("bloo_crypto", Context.MODE_PRIVATE)
