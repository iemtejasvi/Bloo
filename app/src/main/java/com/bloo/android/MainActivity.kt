...
import com.bloo.android.onboarding.BluetoothCheckScreen
import com.bloo.android.onboarding.BluetoothStatus
import com.bloo.android.onboarding.BluetoothStatusManager
import com.bloo.android.onboarding.BatteryOptimizationManager
import com.bloo.android.onboarding.BatteryOptimizationPreferenceManager
import com.bloo.android.onboarding.BatteryOptimizationScreen
import com.bloo.android.onboarding.BatteryOptimizationStatus
import com.bloo.android.onboarding.InitializationErrorScreen
import com.bloo.android.onboarding.InitializingScreen
import com.bloo.android.onboarding.LocationCheckScreen
import com.bloo.android.onboarding.LocationStatus
import com.bloo.android.onboarding.LocationStatusManager
import com.bloo.android.onboarding.OnboardingCoordinator
import com.bloo.android.onboarding.OnboardingState
import com.bloo.android.onboarding.PermissionExplanationScreen
import com.bloo.android.onboarding.PermissionManager
import com.bloo.android.ui.ChatScreen
import com.bloo.android.ui.ChatViewModel
import com.bloo.android.ui.OrientationAwareActivity
import com.bloo.android.ui.theme.BlooTheme
import com.bloo.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.bloo.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.bloo.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.bloo.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.bloo.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.bloo.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.bloo.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.bloo.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.bloo.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.bloo.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.bloo.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.bloo.android.geohash.GeohashChannelLevel.REGION
                        else -> com.bloo.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.bloo.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.bloo.android.geohash.ChannelID.Location(geohashChannel)
