...
//
//    suspend fun saveMessage(message: BlooMessage, forChannel: String) = withContext(Dispatchers.IO) {
...
//    }
//
//    suspend fun loadMessagesForChannel(channel: String): List<BlooMessage> = withContext(Dispatchers.IO) {
...
//    }
//
//    private fun loadMessagesFromFile(file: File): List<BlooMessage> {
//        if (!file.exists()) {
//            return emptyList()
//        }
//
...
//                    ois.readObject() as List<BlooMessage>
//                }
//            }
//        } catch (e: Exception) {
...
//    }
//
//    private fun saveMessagesToFile(file: File, messages: List<BlooMessage>) {
