...
### Added
- Initial Android implementation of Bloo protocol
...
### Added
- Initial release of Bloo Android client
- Basic mesh networking functionality
- Core messaging features
- Protocol compatibility with iOS Bloo client

[Unreleased]: https://github.com/permissionlesstech/Bloo-android/compare/0.5.1...HEAD
[0.5.1]: https://github.com/permissionlesstech/Bloo-android/compare/0.5...0.5.1
[0.5]: https://github.com/permissionlesstech/Bloo-android/compare/0.4...0.5
[0.4]: https://github.com/permissionlesstech/Bloo-android/compare/0.3...0.4
[0.3]: https://github.com/permissionlesstech/Bloo-android/compare/0.2...0.3
[0.2]: https://github.com/permissionlesstech/Bloo-android/compare/0.1...0.2
[0.1]: https://github.com/permissionlesstech/Bloo-android/releases/tag/0.1
